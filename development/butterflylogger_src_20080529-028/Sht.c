...
// 2004-Jul-15  NL  - Adapted for IAR Compiler
// 2005-Jun-00	NL	- Converted back to GCC
//----------------------------------------------------------------------------------
...
void sht_pwrOn(void) 		{
#if EN_LOG_DS1820==0
	sbi(SHT_PORT, SHT_PWR);
#endif
}    // power on
void sht_pwrOff(void) 		{ 
#if EN_LOG_DS1820==0
	cbi(SHT_PORT, SHT_PWR);
#endif
}    // power off
...
int ShtMeasure(unsigned char mode)
{
	...
	/* 
	this can be done on the host computer post logging
	*
//----------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------
// REMOVED as now using delay.c/h
